<template>
 ...
 >
  ...
  <div class="product_card">
   <div class="product_card-avaible">
    <!-- Right -->
    ...
    <div class="product_card-left">
     <h1
      class="product_title"
      :class="product?.data?.category === 'men\'s clothing' ? 'color-darkBlue' : 'color-darkPurple'"
     >
      {{ product?.data?.title }}
     </h1>
      ...
      <div class="product_rating">
       ...
       <div class="product_rating_circle">
        <div
         ...
         :key="maxRate"
         class="circle"
         :class="product?.data?.category === 'men\'s clothing' ? 'bg-darkBlue' : 'bg-darkPurple'"
        ></div>
       </div>
      </div>
     </div>
     ...
     <div class="btn_container">
      ...
      <button
       ...
       :class="
        product?.data?.category === 'men\'s clothing' ? 'border-darkBlue' : 'border-darkPurple'
       "
      >
       Next Product
      </button>
